            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/DashKebabs/updateKebab/<?= $kebab->id ?>" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <img src="/Asset/Images/<?= htmlspecialchars($kebab->img, ENT_QUOTES, 'UTF-8') ?>" alt="Image actuelle" class="img-fluid">
                                </div>
                            </div>
