        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h2 class="text-center">Ajouter un vins</h2>
                </div>
                <div class="card-body">
                    <form action="/DashVins/ajoutVins" method="POST">
                        <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">

                        <!-- Nom du soft -->
                        <div class="mb-3">
                            <label for="nom" class="form-label">Nom du Vins</label>
                            <input type="text" class="form-control" id="nom" name="nom" placeholder="Nom du Vins" required>
                        </div>
