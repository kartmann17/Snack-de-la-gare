        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h2 class="text-center">Ajouter un Tacos</h2>
                </div>
                <div class="card-body">
                    <form action="/DashTacos/ajoutTacos" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">

                        <!-- Nom du burger -->
                        <div class="mb-3">
                            <label for="nom" class="form-label">Nom du tacos</label>
                            <input type="text" class="form-control" id="nom" name="nom" placeholder="Nom du tacos" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="4" placeholder="Description du tacos" required></textarea>
                        </div>

                        <!-- Image -->
                        <div class="mb-3">
                            <label for="img" class="form-label">Image du tacos</label>
